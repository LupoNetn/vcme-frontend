...
const WaitingRoomApproval = () => {
    const { newUserInWaitlistID, newUserInWaitlistName, setNewUserInWaitlistID, setNewUserInWaitlistName, currentCall } = useCallStore();
    ...
    return (
        <div className="fixed top-6 right-6 z-[100] pointer-events-none animate-in slide-in-from-right-10 fade-in duration-500">
            <div className="w-[320px] bg-[#0f172a]/95 backdrop-blur-2xl border border-emerald-500/30 rounded-[24px] shadow-2xl overflow-hidden pointer-events-auto ring-1 ring-white/10">
                {/* Compact Header */}
                <div className="p-4 flex items-center gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                        <h3 className="text-white font-bold text-sm truncate">
                            {newUserInWaitlistName || "New User"}
                        </h3>
